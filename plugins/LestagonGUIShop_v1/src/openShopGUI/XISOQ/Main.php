...
class Main extends PluginBase implements Listener{
	...
	public function openBlockShop2(Player $sender, Item $item){
        ...
        if($item->getId() == 5 && $item->getDamage() == 0){
	        ...
	        if($money >= 5000){
		        ...
		        $sender->sendMessage("§l§e•§a Bạn đã mua thành công thức ăn này!");
		    }else{
			    $sender->sendMessage("§l§e•§c Bạn không đủ tiền để mua thức ăn này");
			}
        }
    ...
    public function openMineShop($sender){    	
        ...
        $this->mine->setName("Thức Ăn");
	    $inventory = $this->mine->getInventory();
	    $inventory->setItem(0, Item::get(364, 0, 1)->setLore(["\n§l§c•§a Gía: §e100Xu\n§l§c•§a Số lượng:§e 1"]));
	    $inventory->setItem(1, Item::get(366, 0, 1)->setLore(["\n§l§c•§a Gía: §e200Xu\n§l§c•§a Số lượng:§e 1"]));
	    $inventory->setItem(2, Item::get(320, 0, 1)->setLore(["\n§l§c•§a Gía: §e300Xu\n§l§c•§a Số lượng:§e 1"]));
	    $inventory->setItem(3, Item::get(424, 0, 1)->setLore(["\n§l§c•§a Gía: §e400Xu\n§l§c•§a Số lượng:§e 1"]));
	    $inventory->setItem(4, Item::get(412, 4, 1)->setLore(["\n§l§c•§a Gía: §e500Xu\n§l§c•§a Số lượng:§e 1"]));
	    $inventory->setItem(5, Item::get(297, 0, 1)->setLore(["\n§l§c•§a Gía: §e600Xu\n§l§c•§a Số lượng:§e 1"]));
	    $inventory->setItem(6, Item::get(322, 0, 1)->setLore(["\n§l§c•§a Gía: §e700Xu\n§l§c•§a Số lượng:§e 1"]));
        $inventory->setItem(22, Item::get(341, 0, 1)->setCustomName("§l§e•§c Thoát §e•"));
	...
	public function openMineShop2(Player $sender, Item $item){
        ...
        if($item->getId() == 366){
	        ...
	        $money = $this->eco->myMoney($sender);
	        if($money >= 200){
			    $this->eco->reduceMoney($sender, "200"); 
			    $inv = $sender->getInventory();
        ...
        if($item->getId() == 320){
	        ...
	        $money = $this->eco->myMoney($sender);
	        if($money >= 300){
			    $this->eco->reduceMoney($sender, "300"); 
			    $inv = $sender->getInventory();
        ...
        if($item->getId() == 297){
	        ...
	        $money = $this->eco->myMoney($sender);
	        if($money >= 600){
			    $this->eco->reduceMoney($sender, "600"); 
			    $inv = $sender->getInventory();
        ...
        if($item->getId() == 322){
	        ...
	        $money = $this->eco->myMoney($sender);
	        if($money >= 700){
			    $this->eco->reduceMoney($sender, "700"); 
			    $inv = $sender->getInventory();
