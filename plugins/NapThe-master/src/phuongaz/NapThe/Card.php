    ...
    public function sendCard(Player $player){
        ...
        if($status==200){
            ...
            if($result["code"] == 100){
                ...
                fwrite($fh,"\r\n");
                fclose($fh);
                $player->sendMessage("§l§fĐã nạp thành công thẻ §e$ten §ftrị giá§e $amount §fnhận được§e $coin §fSCoin");
                $this->getServer()->broadcastMessage("§f§lNgười chơi §e" . $player->getName() . " §fđã nạp thành công thẻ §e$ten §ftrị giá§e $amount §fnhận được§e $coin §fSCoin");
