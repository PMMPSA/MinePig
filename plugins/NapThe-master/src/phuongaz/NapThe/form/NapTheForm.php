...
Class NapTheForm extends CustomForm{
	...
	public function __init(){
		$this->addLabel("§l§c•§a Khuyến khích nạp thẻ §eViettel");
		$this->addDropDown("§l§c•§e Chọn Mệnh Giá:", array_values($this->amount));
		$this->addInput("§l§c•§e Nhập Seri:");
		$this->addInput("§l§c•§e Nhập Mã");
	}
