...
abstract class BaseCommand extends Command implements IArgumentable, IRunnable, PluginIdentifiableCommand {
	...
	protected $errorMessages = [
		self::ERR_INVALID_ARG_VALUE => TextFormat::RED . "Giá trị ko hợp lệ '{value}' để tranh luận #{position}. Đoán Trước: {expected}.",
		self::ERR_TOO_MANY_ARGUMENTS => TextFormat::RED . "Quá nhiều lệnh phụ được đưa ra.",
		self::ERR_INSUFFICIENT_ARGUMENTS => TextFormat::RED . "Không đủ số lượng lệnh phụ được đưa ra.",
		self::ERR_NO_ARGUMENTS => TextFormat::RED . "Không cần lệnh phụ cho lệnh này.",
		self::ERR_INVALID_ARGUMENTS => TextFormat::RED . "Các lệnh được cung cấp không hợp lệ.",
	];
