...
public function onEnable() {
		$this->getLogger()->info("Cây Phát Tài By PIG");
...
$this->sc->save();
$ev->getPlayer()->sendMessage("§l§c•§e Bạn đã nhận được phân bón sơ cấp từ nhiệm vụ");
            }
        }
...
$this->tc->save();
$ev->getPlayer()->sendMessage("§l§c•§e Bạn đã nhận được phân bón trung cấp từ nhiệm vụ");
}
}
}
}
...
$this->cc->save();
$ev->getPlayer()->sendMessage("§l§c•§e Bạn đã nhận được phân bón cao cấp từ nhiệm vụ");
            }
        }
...
$this->n->save();
$ev->getPlayer()->sendMessage("§l§c•§e Bạn đã nhận được nước từ nhiệm vụ");
            }
        }
...
$this->sc->save();
	...
	public function onCommand(CommandSender $sender, Command $command, String $label, array $args) : bool {
	 ...
	 public function menu($sender){
        ...
        $form->setTitle("§l§9⚫§a Cây Phát Tài §9⚫");
		$form->addButton("§l§e• §cThoát §e•");
		$form->addButton("§l§e•§b TOP Cây §e•");
		$form->addButton("§l§e•§b Xem Cây §e•");
		$form->addButton("§l§e•§b Nhiệm Vụ §e•");
        $form->addButton("§l§e•§b Cửa Hàng §e•");
...
$this->lenhcap($sender);
    ...
    public function nhiemvu($sender){
     ...
     $kc = $this->kc->get($sender->getPlayer()->getName());
        ...
        $form->setTitle("§l§9⚫§a Nhiệm Vụ §9⚫");
...
$this->sc->save();
     ...
     $tc = $this->tc->get($sender->getPlayer()->getName());
        ...
        $form->setTitle("§l§9⚫§a Cửa Hàng §9⚫");
        $form->setContent("§l§6•§b Xu của bạn: §e".$mymoney);
        $form->addButton("§l§e•§c Thoát §e•");
        $form->addButton("§l§e•§a Phân Bón Cao Cấp §e•\n§l§bGiá: §e50.000Xu X1");
        $form->addButton("§l§e•§a Phân Bón Trung Cấp §e•\n§l§bGiá: §e50.000Xu X1");
        $form->addButton("§l§e•§a Phân Bón Sơ Cấp §e•\n§l§bGiá: §e50.000Xu X1");
        $form->sendToPlayer($sender);
}
  ...
  if($cc == 0 || $tc == 0 || $sc == 0){
     ...
     $tc = $this->tc->get($sender->getPlayer()->getName());
        ...
        $maxkn = $cap * 500;
        $form->setTitle("§l§9⚫§a Xem Cây §9⚫");
        $form->setContent("§l§e•§b Tên: §a" . $name . "\n§l§e•§b Cấp: §a" . $cap . "\n§l§e•§b EXP: §a" . $kn . "§6§l/".$maxkn."\n--------------------------------\n§l§e↣§a Phân Bón:\n§l§e•§b Phân bón sơ cấp: §a" . $sc . "\n§l§e•§b Phân bón trung cấp: §a" . $tc . "\n§l§e•§b Phân bón cao cấp: §a" . $cc . "\n§l§e•§b Nước: §a" . $n . "\n§l§c⚫§a Sử dụng phân bón và nước để tăng cấp cây phát tài");
        $form->addButton("§l§e•§c Thoát §e•");
        $form->addButton("§l§e•§a Bón Phân §e•");
        $form->addButton("§l§e•§a Tưới Cây §e•");
        $form->sendToPlayer($sender);
    }
    ...
    public function nuoc($sender){
      ...
      $tien = $cap * $tien1;
       $this->eco->addMoney($sender->getPlayer()->getName(), $tien);
             $sender->sendMessage("§l§b❖§a Bạn Đã Nhận ".$tien." Xu Từ Tưới Cây §b❖");
	...
	public function Toplevel(Player $sender){
		...
		if(count($levelplot) > 0){
			...
			foreach($levelplot as $name => $level){
				$message .= "§l§b[§e" . $i . "§b] §a" . $name . " §d↣§6 Cấp§f " . $level . "\n\n";
				$message1 .= "§l§b[§e" . $i . "§b] §a" . $name . " §d↣§6 Cấp§f " . $level . "\n";
				if($i >= 10){
					break;
				}
				++$i;
		...
		$form->setTitle("§l§e✰§a TOP §6Cây §b❖");
